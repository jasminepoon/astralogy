# Brush-first comparison — local build
...
1. Drag outward from the ship to retain a free, bounded vector impulse preview. No home direction or source identity is available before calibration.
